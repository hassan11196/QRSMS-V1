...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='campus',
            name='uni_name',
            field=models.ForeignKey(default='UNIVERSITY_NAME', help_text='A university can have many campuses', on_delete=django.db.models.deletion.SET_DEFAULT, to='institution.University', verbose_name='Universities Campus'),
        ),
    ]
